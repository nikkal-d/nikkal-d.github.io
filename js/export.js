/* ============================================================
   ...
   PDF export • Flipbook HTML export • Cloud placeholder
   ============================================================ */
...
/* ============================================================
   CLOUD EXPORT (placeholder)
   ============================================================ */

function handleExportCloud() {
  alert(
    "Cloud export: σε επόμενο βήμα μπορούμε να το συνδέσουμε με Firebase Storage/Firestore.\n" +
    "Προς το παρόν μπορείς να χρησιμοποιήσεις PDF ή Flipbook export."
  );
}
